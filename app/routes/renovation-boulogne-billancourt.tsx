  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.section}>
        <div className={styles.inner}>
          <div className={styles.sectionHeader}>
            <h2>Périmètre d'Intervention à Boulogne-Billancourt</h2>
            <p>
              Nos équipes d'artisans interviennent dans l'ensemble des quartiers de Boulogne-Billancourt (92100) et ses environs immédiats.
            </p>
          </div>
          ...
          <div style={{ borderRadius: "16px", overflow: "hidden", border: "1px solid var(--color-border, #e2e8f0)", boxShadow: "0 4px 16px rgba(0,0,0,0.06)" }}>
            <iframe
              src="https://maps.google.com/maps?q=Boulogne-Billancourt%2C%2092100%2C%20France&t=&z=13&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="380"
              ...
              title="Carte de la zone d'intervention à Boulogne-Billancourt"
            />
          </div>
        </div>
      </section>
